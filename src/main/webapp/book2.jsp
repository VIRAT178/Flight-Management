        ...
        <div class="box1">
          ...
          <div class="pad"> <strong>Birmingham</strong><br>
            <ul class="pad_bot1 list1">
              <li> <span class="right color1">from GBP 143.-</span> <a href="book2.jsp">Zurich</a> </li>
            </ul>
            <strong>London (LCY)</strong><br>
            <ul class="pad_bot1 list1">
              <li> <span class="right color1">from GBP 176.-</span> <a href="book2.jsp">Geneva</a> </li>
              <li> <span class="right color1">from GBP 109.-</span> <a href="book2.jsp">Zurich</a> </li>
            </ul>
            <strong>London (LHR)</strong><br>
            <ul class="pad_bot2 list1">
              <li> <span class="right color1">from GBP 100.-</span> <a href="book2.jsp">Geneva</a> </li>
              <li> <span class="right color1">from GBP 112.-</span> <a href="book2.jsp">Zurich</a> </li>
              <li> <span class="right color1">from GBP 88.-</span> <a href="book2.jsp">Basel</a> </li>
            </ul>
            <strong>Manchester</strong><br>
            <ul class="pad_bot2 list1">
              <li> <span class="right color1">from GBP 97.-</span> <a href="book2.jsp">Basel</a> </li>
              <li> <span class="right color1">from GBP 103.-</span> <a href="book2.jsp">Zurich</a> </li>
            </ul>
            <strong>Edinburgh</strong><br>
            <ul class="pad_bot2 list1">
              <li> <span class="right color1">from GBP 165.-</span> <a href="book2.jsp">Zurich</a> </li>
            </ul>
                ...
                <div class="wrapper under">
                  <div class="col1">
                    <div class="row"> <span class="left">From</span>
                      <input type="text" class="input" value="from"  >
                    </div>
